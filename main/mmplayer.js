/*
 * mp3 player v0.3.0 - a music player built with HTML5 audio API =>_<=
 * visit the project page on github :https://github.com/Xia-lj/MusicPlayer/
 * see the live demo :https://github.com/Xia-lj/MusicPlayer/
 */
'use strict'
...
MmPlayer.prototype = {
    ...
    shuffleList: function() {
        ...
        for (var i = 0; i<l; i++) {
            ...
            li.innerHTML = '<span class="remove" title="remove from list">x</i></span>' + '<span class="title">' + this.playlist[i].name.slice(0, -4) + '</span>';
